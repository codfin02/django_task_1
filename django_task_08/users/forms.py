...
class LoginForm(AuthenticationForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs.update({'class': 'form-control', 'placeholder': '이메일을 입력해주세요.'})
        self.fields['password'].widget.attrs.update({'class': 'form-control', 'placeholder': '비밀번호를 입력해주세요.'})
